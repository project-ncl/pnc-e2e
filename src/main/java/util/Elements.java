 ...
 * Elements that can be clicked on on pnc-web
 */
public class Elements {
    ...
    public static final String PRODUCT_ABBREVIATION = "abbreviation";
    ...
    public static final String NAME_PARAGRAPH = "input-name";
    public static final String DESCRIPTION_PARAGRAPH = "input-description";
    public static final String ABBREVIATION_PARAGRAPH = "input-abbreviation";
    public static final String CODE_PARAGRAPH = "input-productCode";
    public static final String SYSTEM_NAME_PARAGRAPH = "input-pgmSystemName";

    public static final String PROJECT_DESCRIPTION_PARAGRAPH = "static-description";
    ...
    public static final String CREATE_CONFIGURATION_BUTTON = "Create a new build configuration";
    ...
    public static final String BUILD_CONFIGURATION_SCM_URL_EXTERNAL = "scmRepoURLExternal";
    public static final String BUILD_CONFIGURATION_SCM_REVISION_EXTERNAL = "scmRevisionExternal";    
